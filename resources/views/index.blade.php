...
<title>Mommy Ambol Car Rental</title>
<!--Bootstrap -->
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1 style="">Find the right car for you.</h1>
...
<div class="car-info-box"> <a href=" "><img src="{{asset('uploads/car/'.$index->image)}}" class="img-responsive" alt="image"></a>
<ul>
<li><i class="fa fa-car" aria-hidden="true"></i>{{$index->carname}}</li>
<li><i class="fa fa-calendar" aria-hidden="true"></i>{{$index->carmodel}}</li>
<li><i class="fa fa-user" aria-hidden="true"></i>{{$index->carseats}}</li>
</ul>
</div>
<div class="car-title-m">
<h6><a href=" " style="text-decoration: none;"><h3>{{$index->cartype}}</h3></a></h6>
...
<p> 
  ...
  @endif -->
  <p>Car Status: <button class="" style="color:green">Available</button></p>
</p>
<br>
  ...
  <div class="container div_zindex">
    <div class="row">
      ...
      <div class="col-lg-3 col-xs-6 col-sm-3">
        <div class="fun-facts-m">
          <div class="cell">
            <h2><i class="fa fa-user-circle-o" aria-hidden="true"></i>50+</h2>
